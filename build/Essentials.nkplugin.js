...
// cssThemes.js
var require_cssThemes = __commonJS({
  "cssThemes.js"(exports2, module2) {
    module2.exports = {
      cssThemes: {
        // UI Improvements
        ForumImprovements: `
...
var require_CoreUISection = __commonJS({
  "components/CoreUISection.jsx"(exports2, module2) {
    ...
    function CoreUISection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Core UI Improvements" }), /* @__PURE__ */ React.createElement("div", { className: `${settings.GridView ? "settings-grid" : ""} mt-8` }, filterSettings(
        "Forum Improvements",
...
var require_InterfaceSection = __commonJS({
  "components/InterfaceSection.jsx"(exports2, module2) {
    ...
    function InterfaceSection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Interface Tweaks" }), /* @__PURE__ */ React.createElement("div", { className: settings.GridView ? "settings-grid" : "" }, filterSettings(
...
var require_ChatSection = __commonJS({
  "components/ChatSection.jsx"(exports2, module2) {
    ...
    function ChatSection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Chat Features" }), /* @__PURE__ */ React.createElement("div", { className: settings.GridView ? "settings-grid" : "" }, filterSettings(
...
var require_VisualSection = __commonJS({
  "components/VisualSection.jsx"(exports2, module2) {
    ...
    function VisualSection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Visual Enhancements" }), /* @__PURE__ */ React.createElement("div", { className: `${settings.GridView ? "settings-grid" : ""} mt-8` }, filterSettings(
        "Discolored",
...
var require_FunSection = __commonJS({
  "components/FunSection.jsx"(exports2, module2) {
    ...
    function FunSection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Fun & Experimental" }), /* @__PURE__ */ React.createElement("div", { className: `${settings.GridView ? "settings-grid" : ""} mt-8` }, filterSettings(
...
var require_OnekoSection = __commonJS({
  "components/OnekoSection.jsx"(exports2, module2) {
    ...
    function OnekoSection({ settings, filterSettings, handleToggle, handlePreviewClick }) {
      return /* @__PURE__ */ React.createElement("div", { className: "settings-section mb-16" }, /* @__PURE__ */ React.createElement(SectionHeader, { title: "Oneko Skins" }), /* @__PURE__ */ React.createElement("div", { className: `${settings.GridView ? "settings-grid" : ""} mt-8` }, filterSettings(
        "Eevee Oneko",
  ...
  "components/M0chaTweaksTab.jsx"(exports2, module2) {
    ...
    function M0chaTweaksTab2() {
      ...
      const enabledCounts = React.useMemo(() => {
        const coreUI = Object.entries(settings).filter(
          ([key, value]) => value && [
            "ForumImprovements",
            "AppearanceTabImprovements",
            "HideNoPermissionChat",
        ...
        const interface_ = Object.entries(settings).filter(
          ([key, value]) => value && [
            "HidePlayAgain",
            "FullServerTooltips",
            "CenteredChannelNames",
        ...
        const chat = Object.entries(settings).filter(
          ([key, value]) => value && [
            "CustomChatPlaceholder",
            "CustomChatPlaceholderAlt",
            "HideTimestamps",
        ...
        const visual = Object.entries(settings).filter(
          ([key, value]) => value && [
            "PastelStatuses",
            "LargeEmojis",
            "ReactionAnimations",
        ...
        const fun = Object.entries(settings).filter(
          ([key, value]) => value && [
            "DiscordHardcore",
            "GayFolders",
            "GradientDMs",
...
var { cssThemes } = require_cssThemes();
